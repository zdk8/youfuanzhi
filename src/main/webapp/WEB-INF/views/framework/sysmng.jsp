...
<head>
    ...
    <title>丽水市防震减灾公共服务信息系统二期-系统管理</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/sysmng.css"/>
...
<div data-options="region:'north',border:false" style="margin:0;padding:0;height:80px;">
    ...
    box-sizing: border-box;
        ...
        <table class="nav-header" cellspacing="0"><tr>
            ...
            <td><span style="font-size: 20px;color: white;padding-left:5px;">丽水市防震减灾公共服务信息系统二期</span></td>
        </tr></table>
        <table class="nav-header nav-header-right" cellspacing="0"><tr>
            <td>开发中，ip地址经常变动，修改hosts文件，添加<span style="color:red;">hvit.in.server</span></td>
            <td style="vertical-align: middle;height: 80px;">
                您好：<%= user == null ? "未登录" : user.getUsername()%>
            </td>
            <td>
...
<script src="http://hvit.in.server:3000/hvit-front-framework/require.js"
        data-main="apps/lishui2qi/sysmng.app.js?v=1"></script>