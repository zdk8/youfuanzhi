...
L.WFST = L.GeoJSON.extend({
    ...
    initialize: function(geojson,options){
        ...
        console.log( initOptions.typename)
    ...
    */
    ...
    _wfstAdd: function(layer,options){
        ...
        //console.log(typeof layer.feature._wfstSaved)
        //console.log(layer.feature._wfstSaved)
    ...
    _wfstSave: function(layer,options){
        ...
        options = L.extend(options,{
            success: function(res){
                console.log("更新成功。")
                console.log(realsuccess)
                console.log(self._wfstSuccess(res))
                if(typeof realsuccess == 'function' && self._wfstSuccess(res)){
                    layer.feature._wfstSaved = true;
                    realsuccess(res);
                }else if(typeof options.failure == 'function'){ 
    ...
    _wfstSetValues: function(layer){
        ...
        console.log(this.options.featureNS)
        ...
        for(var f in field){
            ...
            //为插入添加的图上名称初始值为空；
            xml+="<"+this.options.featureNS+":"+"tsmc>1</"+this.options.featureNS+":tsmc>"
    ...
    _wfstValueKeyPairs: function(layer){
        ...
        for(var p = 0;p < elems.length;p++){
          ...
          /*  switch (attr){
            ...
            console.log("attr")
            console.log(attr)
            console.log(typeof layer.feature != 'undefined' &&
            typeof layer.feature.properties != 'undefined' &&
            typeof layer.feature.properties[attr] != 'undefined')
            console.log( elems[p].getAttribute('type'))
            console.log(elems[p].getAttribute('nillable') == 'false')
            ...
            if( typeof layer.feature != 'undefined' && 
                ...
                console.log(layer.feature.properties[attr] === null && !elems[p].getAttribute('nillable'))
        ...
        console.log("打印字段名称；")
        console.log(field[this.options.geomField])
        console.log(this.options.geomField)
        console.log(field)
