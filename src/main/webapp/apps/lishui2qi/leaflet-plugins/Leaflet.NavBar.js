...
(function() {
    L.Control.NavBar = L.Control.extend({
        options: {
            ...
            //center:,
            //zoom :,
            forwardTitle:'往前一步',// 'Go forward in map view history',
            backTitle:'后退一步',// 'Go back in map view history',
            homeTitle:'复位'// 'Go to home map view'
        },
        ...
        onAdd: function(map) {
            ...
            var controlName = 'leaflet-control-navbar',
                container = L.DomUtil.create('div', controlName + ' leaflet-bar tom-custom-navbar');
