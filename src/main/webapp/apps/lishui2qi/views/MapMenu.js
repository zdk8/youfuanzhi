        ...
        return {
            render: function (local, clickFn) {
                ...
                var MenuList = Backbone.Collection.extend({
                    ...
                    url: 'data-json/product/map-menu-data.json',
                    model: Menu
                });
                var Menus = new MenuList;
                var template_htm = '<a class="dir leaf text"><%=title%> <span class="checkbox"></span></a>';
                var MenuView = Backbone.View.extend({
                    ...
                    clickLeaf: function (event) {
                        ...
                        $(this.el).parent().find('.checkbox').removeClass('selected');
                        if(!isSelected) {
